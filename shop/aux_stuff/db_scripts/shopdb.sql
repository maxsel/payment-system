...
-- -----------------------------------------------------
-- Table `shopdb`.`item_in_cart`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `shopdb`.`item_in_cart` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `shopdb`.`item_in_cart` (
...
SHOW WARNINGS;
CREATE INDEX `fk_item-in-cart_item1_idx` ON `shopdb`.`item_in_cart` (`item_id` ASC);

SHOW WARNINGS;
CREATE UNIQUE INDEX `item_in_cart_id_UNIQUE` ON `shopdb`.`item_in_cart` (`item_in_cart_id` ASC);

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `shopdb`.`user_has_item_in_cart`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `shopdb`.`user_has_item_in_cart` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `shopdb`.`user_has_item_in_cart` (
  `user_id` INT NOT NULL,
  `item_in_cart_id` INT NOT NULL,
  PRIMARY KEY (`user_id`, `item_in_cart_id`),
  ...
  CONSTRAINT `fk_user_has_item-in-cart_item-in-cart1`
    FOREIGN KEY (`item_in_cart_id`)
    REFERENCES `shopdb`.`item_in_cart` (`item_in_cart_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
SHOW WARNINGS;
CREATE INDEX `fk_user_has_item-in-cart_item-in-cart1_idx` ON `shopdb`.`user_has_item_in_cart` (`item_in_cart_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_user_has_item-in-cart_user1_idx` ON `shopdb`.`user_has_item_in_cart` (`user_id` ASC);
